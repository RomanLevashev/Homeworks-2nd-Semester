// <copyright file="SkipList.cs" company="Roman Levashev">
    ...
    where T : IComparable<T>
{
    ...
    private SkipListNode<T> head = new(default);
    ...
    public T this[int index]
    {
        ...
        set
        {
            throw new NotSupportedException("Setting value by index is not supported in SkipList.");
        }
    }
    ...
    {
        throw new NotSupportedException("Insertion by index is not supported in SkipList. Use Add(item) instead.");
    }
    ...
    private class SkipListNode<TNode>(TNode? value)
    {
        /// <summary>
        ...
        /// </summary>
        public Dictionary<int, SkipListNode<TNode>> Forward { get; } = new();
    }
}
